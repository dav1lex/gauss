...
export const Icons = {
  ...
  ExternalLink: (props: React.ComponentProps<typeof ExternalLink>) => <ExternalLink {...props} />,
  Send: (props: React.ComponentProps<typeof Send>) => <Send {...props} />,
  ...
  // Sync & Automation
  Refresh: (props: React.ComponentProps<typeof RefreshCcw>) => <RefreshCcw {...props} />,
  
  // E-commerce
  ShoppingCart: (props: React.ComponentProps<typeof ShoppingCart>) => <ShoppingCart {...props} />,
  
  // Search & SEO
  Search: (props: React.ComponentProps<typeof Search>) => <Search {...props} />,
  
  // Lightbulb & Ideas
  Lightbulb: (props: React.ComponentProps<typeof Lightbulb>) => <Lightbulb {...props} />,
  
  // Support
  Support: (props: React.ComponentProps<typeof Headphones>) => <Headphones {...props} />,
  
  // Email
  Mail: (props: React.ComponentProps<typeof Mail>) => <Mail {...props} />,
  
  // Wallet / Money
  Wallet: (props: React.ComponentProps<typeof Wallet>) => <Wallet {...props} />,
  
  // Briefcase / Work
  Briefcase: (props: React.ComponentProps<typeof Briefcase>) => <Briefcase {...props} />,
  
  // Academic / Learning
  AcademicCap: (props: React.ComponentProps<typeof GraduationCap>) => <GraduationCap {...props} />,
  
  // Phone & Contact
  Phone: (props: React.ComponentProps<typeof Phone>) => <Phone {...props} />,
  
  // Location
  MapPin: (props: React.ComponentProps<typeof MapPin>) => <MapPin {...props} />,
  
  // Time
  Clock: (props: React.ComponentProps<typeof Clock>) => <Clock {...props} />,
  
  // Star rating
  Star: (props: React.ComponentProps<typeof Star>) => <Star {...props} />,
...
// Icon with container (bordered icon box)
export function IconBox({ icon, className }: { icon: React.ReactNode, className?: string }) {
  return (
    <div className={cn('w-12 h-12 border border-border rounded-lg flex items-center justify-center', className)}>
      {icon}
    </div>
  )
}
